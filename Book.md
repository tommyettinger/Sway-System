...
- Athletics:Climb {T}
  ...
  - Climbing any surface without any natural climbing ability is very slow compared to moving normally. An animal built for mountainous terrain, like a goat, can move at about half speed up any surface. A specialized climber like a monkey can move at full speed up the surfaces it is used to, such as trees for a monkey.
